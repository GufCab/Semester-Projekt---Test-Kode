    ...
    public class DvAVTransport : IUPnPService
    {
        ...
        private class _DvAVTransport
        {
            ...
            protected UPnPService BuildUPnPService()
            {
                ...
                RetVal[2] = new UPnPModeratedStateVariable("PlaybackStorageMedium", typeof(System.String), false);
                RetVal[2].AllowedStringValues = new string[33]{"UNKNOWN", "DV", "MINI-DV", "VHS", "W-VHS", "S-VHS", "D-VHS", "VHSC", "VIDEO8", "HI8", "CD-ROM", "CD-DA", "CD-R", "CD-RW", "VIDEO-CD", "SACD", "MD-AUDIO", "MD-PICTURE", "DVD-ROM", "DVD-VIDEO", "DVD-R", "DVD+RW", "DVD-RW", "DVD-RAM", "DVD-AUDIO", "DAT", "LD", "HDD", "MICRO-MV", "NETWORK", "NONE", "NOT_IMPLEMENTED", " vendor-defined "};
                RetVal[2].AddAssociation("GetMediaInfo", "PlayMedium");
                RetVal[3] = new UPnPModeratedStateVariable("RecordStorageMedium", typeof(System.String), false);
                RetVal[3].AllowedStringValues = new string[33]{"UNKNOWN", "DV", "MINI-DV", "VHS", "W-VHS", "S-VHS", "D-VHS", "VHSC", "VIDEO8", "HI8", "CD-ROM", "CD-DA", "CD-R", "CD-RW", "VIDEO-CD", "SACD", "MD-AUDIO", "MD-PICTURE", "DVD-ROM", "DVD-VIDEO", "DVD-R", "DVD+RW", "DVD-RW", "DVD-RAM", "DVD-AUDIO", "DAT", "LD", "HDD", "MICRO-MV", "NETWORK", "NONE", "NOT_IMPLEMENTED", " vendor-defined "};
                ...
                RetVal[6] = new UPnPModeratedStateVariable("TransportState", typeof(System.String), false);
                RetVal[6].AllowedStringValues = new string[7]{"STOPPED", "PAUSED_PLAYBACK", "PAUSED_RECORDING", "PLAYING", "RECORDING", "TRANSITIONING", "NO_MEDIA_PRESENT"};
                RetVal[6].AddAssociation("GetTransportInfo", "CurrentTransportState");
                RetVal[7] = new UPnPModeratedStateVariable("PossiblePlaybackStorageMedia", typeof(System.String), false);
                RetVal[7].AddAssociation("GetDeviceCapabilities", "PlayMedia");
                RetVal[8] = new UPnPModeratedStateVariable("CurrentPlayMode", typeof(System.String), false);
                RetVal[8].DefaultValue = UPnPService.CreateObjectInstance(typeof(System.String),"NORMAL");
                RetVal[8].AllowedStringValues = new string[3]{"NORMAL", "REPEAT_ALL", "INTRO"};
                RetVal[8].AddAssociation("GetTransportSettings", "PlayMode");
                RetVal[8].AddAssociation("SetPlayMode", "NewPlayMode");
                RetVal[9] = new UPnPModeratedStateVariable("TransportStatus", typeof(System.String), false);
                RetVal[9].AllowedStringValues = new string[3]{"OK", "ERROR_OCCURRED", " vendor-defined "};
                RetVal[9].AddAssociation("GetTransportInfo", "CurrentTransportStatus");
                RetVal[10] = new UPnPModeratedStateVariable("CurrentRecordQualityMode", typeof(System.String), false);
                RetVal[10].AllowedStringValues = new string[8]{"0:EP", "1:LP", "2:SP", "0:BASIC", "1:MEDIUM", "2:HIGH", "NOT_IMPLEMENTED", " vendor-defined "};
                RetVal[10].AddAssociation("GetTransportSettings", "RecQualityMode");
                RetVal[11] = new UPnPModeratedStateVariable("CurrentTrackDuration", typeof(System.String), false);
                RetVal[11].AddAssociation("GetPositionInfo", "TrackDuration");
                RetVal[12] = new UPnPModeratedStateVariable("CurrentTrackURI", typeof(System.String), false);
                RetVal[12].AddAssociation("GetPositionInfo", "TrackURI");
                ...
                RetVal[18] = new UPnPModeratedStateVariable("AVTransportURIMetaData", typeof(System.String), false);
                RetVal[18].AddAssociation("GetMediaInfo", "CurrentURIMetaData");
                RetVal[18].AddAssociation("SetAVTransportURI", "CurrentURIMetaData");
                ...
                RetVal[22] = new UPnPModeratedStateVariable("CurrentTransportActions", typeof(System.String), false);
                RetVal[22].AddAssociation("GetCurrentTransportActions", "Actions");
                ...
                RetVal[26].AllowedStringValues = new string[2]{"1", " vendor-defined "};
                ...
                RetVal[28].SetRange((System.UInt32)(0),(System.UInt32)(4294967295),null);
                ...
                UPnPService S = new UPnPService(1, "urn:schemas-upnp-org:service:AVTransport", URN, true, this);
