...
static void printIP (struct in_addr * inaddr);
...
void printIP (struct in_addr * inaddr)
{
	printf ("%d.%d.%d.%d\n", (inaddr->s_addr)&0xFF, (inaddr->s_addr>>8)&0xFF, (inaddr->s_addr>>16)&0xFF, inaddr->s_addr>>24&0xFF);
}
...
int ILibGetLocalIPAddressList(int** pp_int)
{
	...
	*pp_int = NULL;
	...
	return GetMacIPv4Addresses((void **)pp_int, GetAddressMemInt, StoreValInt);
	/*
	int ctr = 0;
	struct ifaddrs *ifaddr, *ifa;
